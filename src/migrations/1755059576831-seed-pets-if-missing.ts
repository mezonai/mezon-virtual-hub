...
export class SeedPetsIfMissing1755059576831 implements MigrationInterface {
    species = 'SeedPetsIfMissing1755059576831'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const pets: [string, AnimalRarity, PetType, number, number, number, number, number][] = [
            ...
            ['PhoenixIce', AnimalRarity.LEGENDARY, PetType.FIRE, 106, 110, 90, 130, 120],
        ...
        for (const [species, rarity, type, base_hp, base_attack, base_defense, base_speed, catch_chance] of pets) {
            const exists = await queryRunner.query(
                `SELECT 1 FROM pets WHERE species = $1 AND rarity = $2 LIMIT 1`,
                [species, rarity]
            );
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        const speciesRarityPairs: [string, AnimalRarity][] = [
            ['Bird', AnimalRarity.COMMON], ['Bird', AnimalRarity.RARE],
            ['Cat', AnimalRarity.COMMON], ['Cat', AnimalRarity.RARE],
            ['Dog', AnimalRarity.COMMON], ['Dog', AnimalRarity.RARE],
            ['Rabit', AnimalRarity.COMMON], ['Rabit', AnimalRarity.RARE],
            ['Sika', AnimalRarity.COMMON], ['Sika', AnimalRarity.RARE], ['Sika', AnimalRarity.EPIC],
            ['Pokemon', AnimalRarity.COMMON], ['Pokemon', AnimalRarity.RARE], ['Pokemon', AnimalRarity.EPIC], ['Pokemon', AnimalRarity.LEGENDARY],
            ['Dragon', AnimalRarity.COMMON], ['Dragon', AnimalRarity.RARE], ['Dragon', AnimalRarity.EPIC], ['Dragon', AnimalRarity.LEGENDARY],
            ['PhoenixIce', AnimalRarity.EPIC], ['PhoenixIce', AnimalRarity.LEGENDARY],
            ['DragonIce', AnimalRarity.LEGENDARY],
            ['Snowria', AnimalRarity.COMMON], ['Snowria', AnimalRarity.RARE], ['Snowria', AnimalRarity.EPIC],
            ['Leafeon', AnimalRarity.EPIC], ['Leafeon', AnimalRarity.COMMON], ['Leafeon', AnimalRarity.RARE],
            ['Lizard', AnimalRarity.RARE], ['Lizard', AnimalRarity.EPIC],
            ['Duskar', AnimalRarity.COMMON], ['Duskar', AnimalRarity.RARE], ['Duskar', AnimalRarity.EPIC], ['Duskar', AnimalRarity.LEGENDARY],
            ['Bubblespark', AnimalRarity.RARE], ['Bubblespark', AnimalRarity.EPIC],
            ['PhoenixFire', AnimalRarity.EPIC], ['PhoenixIce', AnimalRarity.LEGENDARY],
            ['DragonNormal', AnimalRarity.LEGENDARY], ['DragonFire', AnimalRarity.LEGENDARY]
        ];

        for (const [species, rarity] of speciesRarityPairs) {
            await queryRunner.query(
                `DELETE FROM pets WHERE species = $1 AND rarity = $2`,
                [species, rarity]
            );
        }
    }
