...
export class CreateFarmSlotTable1761274342970 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ALTER TABLE "farm_slots" ADD CONSTRAINT "FK_farm_slot_farm" FOREIGN KEY ("farm_id") REFERENCES "farms"("id") ON DELETE CASCADE ON UPDATE CASCADE;
    `);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "farm_slots" DROP CONSTRAINT IF EXISTS "FK_farm_slot_farm";`
    );
    await queryRunner.query(`DROP TABLE IF EXISTS "farm_slots";`);
  }
}
