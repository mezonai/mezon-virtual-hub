...
export class CreateSlotPlantTable1761274414316 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "slot_plants" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "farm_slot_id" uuid NOT NULL, "plant_id" uuid NOT NULL, "plant_name" character varying NOT NULL, "stage" integer NOT NULL DEFAULT 1, "planted_by" uuid NOT NULL, "last_harvested_by" uuid, "grow_time" integer NOT NULL, "harvest_at" TIMESTAMP, "total_water_count" integer NOT NULL DEFAULT '0', "total_bug_caught" integer NOT NULL DEFAULT '0', "expected_water_count" integer NOT NULL DEFAULT '0', "expected_bug_count" integer NOT NULL DEFAULT '0', "last_watered_at" TIMESTAMP, "need_water_until" TIMESTAMP, "last_bug_caught_at" TIMESTAMP, "bug_until" TIMESTAMP, "harvest_count" integer NOT NULL DEFAULT '0', "harvest_count_max" integer NOT NULL DEFAULT '10', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_slot_plant_id" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
