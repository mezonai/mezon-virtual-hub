export enum MessageTypes {
  ...
  ON_SEND_CLAN_FUND_FAILED = 'onSendClanFundFailed',
  ON_SEND_CLAN_FUND_SELF = 'onSendClanFundSelf',
  ON_SEND_CLAN_UPDATE = 'onSendClanUpdated',
  ON_BUY_CLAN_ITEM = 'buyClanItem',
