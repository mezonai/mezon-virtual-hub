...
export class MapDecorConfigController {
  ...
  getAll(@Query() query: MapDecorConfigQueryDto) {
    return this.configService.getAllMapDecorConfigs(query);
  }
  ...
  getById(@Param('id') id: string) {
    return this.configService.getMapDecorConfigById(id);
  }
  ...
  placeDecor(@Query() dto: CreateMapDecorConfigDto) {
    return this.configService.placeDecorItemToPlaceholder(dto);
  }
  ...
  removeDecor(@Param('id') id: string) {
    return this.configService.removeDecorFromPlaceholder(id);
  }
}
